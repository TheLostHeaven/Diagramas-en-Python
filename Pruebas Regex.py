...
#Bucle para retomar como checkpoint si seleccionan mal
    seleccion = input("Escribe el numero de tu seleccion\n  1. Si! >:) \n  2. No! >:(\n")
...
#Inicialización para tomar el camino
    ...
    if camino1 == 2: #elejiste izquierda
        ...
        if nadar == 1: #Elejiste nadar
            ...
            #Checkpoint para retomar
            while puertas != 1 and puertas != 2 and puertas !=3:
             print("Selecciona una opcion valida")
             sleep(2)
             puertas = int(input("¿A cual puerta entraras?\n  1.Roja\n  2.Amarillo\n  3.Azul\n"))
            ...
            if puertas == 3: #Elejiste la puerta azul
                ...
                if replay1 == 1:
                    ...
                    break
    else: #Si el usuario pone otro numero que no sea el 1 o 2 le tirara error y re ejecutara el codigo
        print("Selecciona una opción valida")